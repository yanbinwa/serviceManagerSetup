#!/bin/sh
docker run -i -t -d --net yanbin -p 9102:9102 --ip 172.18.0.42 --name kafka_2 ubuntu:v2 /bin/bash
docker run -i -t -d --net yanbin -p 9103:9103 --ip 172.18.0.43 --name kafka_3 ubuntu:v2 /bin/bash
...
docker run -i -t -d --net yanbin -p 9101:9101 --ip 172.18.0.41 --name kafka_1 ubuntu:v2 /bin/bash
